(() => {
  ...
  var init_web3 = __esm({
    "node_modules/@capacitor/dialog/dist/esm/web.js"() {
      init_dist();
      DialogWeb = class extends WebPlugin {
        async alert(options) {
  ...
  var Dialog = registerPlugin("Dialog", {
    web: () => Promise.resolve().then(() => (init_web3(), web_exports3)).then((m) => new m.DialogWeb())
  });
  ...
  function s2ab(s2) {
    ...
    for (var i = 0; i != s2.length; ++i) view[i] = s2.charCodeAt(i) & 255;
    return buf;
  }
  function a2s(data) {
  ...
  function commaify(s2) {
    ...
    var j = s2.length % w, o = s2.substr(0, j);
  ...
  function SSF_format(fmt, v, o) {
    ...
    if (SSF_isgeneral(f2[1])) return SSF_general(v, o);
    if (v === true) v = "TRUE";
    else if (v === false) v = "FALSE";
    else if (v === "" || v == null) return "";
    return eval_fmt(f2[1], v, o, f2[0]);
  }
  ...
  function parse_isodur(s2) {
    ...
    var m = s2.match(/P([0-9\.]+Y)?([0-9\.]+M)?([0-9\.]+D)?T([0-9\.]+H)?([0-9\.]+M)?([0-9\.]+S)?/);
    if (!m) throw new Error("|" + s2 + "| is not an ISO8601 Duration");
  ...
  function fuzzydate(s2) {
    var o = new Date(s2), n = /* @__PURE__ */ new Date(NaN);
  ...
  function safegetzipfile(zip, file) {
    ...
    for (var i = 0; i < k.length; ++i) {
      ...
      if (f2 == n || g == n) return zip.files ? zip.files[k[i]] : zip.FileIndex[i];
    }
    return null;
  }
  ...
  var unescapexml = /* @__PURE__ */ (function() {
    ...
    return function unescapexml2(text) {
      ...
      if (i == -1) return s2.replace(encregex, function($$, $1) {
  ...
  var ___utf16le = function(b, s2, e) {
    var ss = [];
    for (var i = s2; i < e; i += 2) ss.push(String.fromCharCode(__readUInt16LE(b, i)));
  ...
  var ___hexlify = function(b, s2, l) {
    var ss = [];
    for (var i = s2; i < s2 + l; ++i) ss.push(("0" + b[i].toString(16)).slice(-2));
    return ss.join("");
  };
  ...
  var ___utf8 = function(b, s2, e) {
    var ss = [];
    for (var i = s2; i < e; i++) ss.push(String.fromCharCode(__readUInt8(b, i)));
    return ss.join("");
  };
  ...
  function cpdoit() {
    __utf16le = function(b, s2, e) {
      return $cptable.utils.decode(1200, b.slice(s2, e)).replace(chr0, "");
    };
    __utf8 = function(b, s2, e) {
      return $cptable.utils.decode(65001, b.slice(s2, e));
    };
  ...
  function parse_core_props(data) {
    ...
    for (var i = 0; i < CORE_PROPS.length; ++i) {
      ...
      if (cur != null && cur.length > 0) p[f2[1]] = unescapexml(cur[1]);
      if (f2[2] === "date" && p[f2[1]]) p[f2[1]] = parseDate(p[f2[1]]);
    }
    return p;
  }
  function cp_doit(f2, g, h, o, p) {
    if (p[f2] != null || g == null || g === "") return;
    p[f2] = g;
    g = escapexml(g);
    o[o.length] = h ? writextag(f2, g, h) : writetag(f2, g);
  }
  function write_core_props(cp, _opts) {
    ...
    for (var i = 0; i != CORE_PROPS.length; ++i) {
      ...
      if (v != null) cp_doit(f2[0], v, null, o, p);
    }
    if (o.length > 2) {
    ...
    EXT_PROPS.forEach(function(f2) {
      ...
      switch (f2[2]) {
        ...
        case "raw":
          ...
          if (cur && cur.length > 0) q[f2[1]] = cur[1];
          break;
      }
    });
  ...
  function write_ext_props(cp) {
    ...
    EXT_PROPS.forEach(function(f2) {
      ...
      if (v !== void 0) o[o.length] = W(f2[0], v);
    });
  ...
  function write_Format(i, f2, opts, o) {
    ...
    if (!o) o = new_buf(b5 ? 3 + f2.length : 5 + 2 * f2.length);
    o.write_shift(2, i);
  ...
  function parse_TxO(blob, length, opts) {
    ...
    try {
      ...
      for (var i = 1; i < blob.lens.length - 1; ++i) {
        if (blob.l - s2 != blob.lens[i]) throw new Error("TxO: bad continue record");
        var hdr = blob[blob.l];
  ...
  var WK_ = /* @__PURE__ */ (function() {
    ...
    function lotus_to_workbook_buf(d, opts) {
      ...
      var o = opts || {};
      if (DENSE != null && o.dense == null) o.dense = DENSE;
      var s2 = o.dense ? [] : {}, n = "Sheet1", next_n = "", sidx = 0;
    ...
    function parse_NUMBER_17(blob, length) {
      ...
      var s2 = e & 32768;
      e = (e & 32767) - 16446;
      o[1].v = (1 - s2 * 2) * (v2 * Math.pow(2, e + 32) + v1 * Math.pow(2, e));
      return o;
    }
  ...
  function shift_formula_xlsx(f2, range, cell) {
    var r = decode_range(range), s2 = r.s, c = decode_cell(cell);
  ...
  function parse_ws_xml(data, opts, idx, rels, wb, themes, styles) {
    ...
    else if (sheetPr = data1.match(sheetprregex2)) parse_ws_xml_sheetpr2(sheetPr[0], sheetPr[1] || "", s2, wb, idx, styles, themes);
  ...
  function parse_cs_xml(data, opts, idx, rels, wb) {
    ...
    if (sheetPr) parse_ws_xml_sheetpr(sheetPr[0], s2, wb, idx);
    if (m = data.match(/drawing r:id="(.*?)"/)) s2["!rel"] = m[1];
  ...
  function parse_workbook(blob, options) {
          ...
          case 2057:
            {
              ...
              if (opts.biff < 5 || val.BIFFVer == 0 && val.dt == 4096) {
                ...
                Directory2[fakebs8.pos] = fakebs8;
                opts.snames.push(cur_sheet);
              } else cur_sheet = (Directory2[s2] || { name: "" }).name;
              ...
              rowinfo = [];
              seencol = false;
              wsprops = { Hidden: (Directory2[s2] || { hs: 0 }).hs, name: cur_sheet };
            }
            break;
          case 515:
          case 3:
    ...
    wb.SheetNames = keys(Directory2).sort(function(a, b) {
      return Number(a) - Number(b);
    }).map(function(x) {
      return Directory2[x].name;
    });
